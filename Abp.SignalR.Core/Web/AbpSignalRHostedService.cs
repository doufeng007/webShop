...
{
    public abstract class AbpSignalRHostedService : IHostedService
    {
        ...
        {
            // Create a linked token so we can trigger cancellation ouvtside of this token's cancellation
