    ...
    public class AccessTokenContainer
    {
        ...
        public static AccessTokenResult GetTokenResult(string appId, bool getNewToken = false)
        {
            ...
            if (getNewToken || accessTokenBag.ExpireTime <= DateTime.Now)
            {
                ...
                //var retjson = Newtonsoft.Json.JsonConvert.SerializeObject(accessTokenBag.AccessTokenResult);
                //var logService =
                //         Abp.AbpBootstrapper.Create<Abp.Modules.AbpModule>()
                //             .IocManager.IocContainer.Resolve<Logapp.ILogAppService>();
                //logService.CreateOrUpdateLogV3("错误", $"resultInfo:{retjson} ", "04");
