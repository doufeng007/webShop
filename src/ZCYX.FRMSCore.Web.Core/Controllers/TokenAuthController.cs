...
namespace ZCYX.FRMSCore.Controllers
{
    ...
    public class TokenAuthController : FRMSCoreControllerBase
    {
        ...
        private async Task<ExternalAuthUserInfo> GetExternalUserInfo(ExternalAuthenticateModel model)
        {
            ...
            {
                throw new UserFriendlyException((int)ErrorCode.CodeValErr, L("CouldNotValidateExternalUser"));
            }
