...
namespace ZCYX.FRMSCore.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(FRMSCoreDbContext context, IAbpPermissionBaseAppService abpPermissionBaseAppService)
        {
            _context = context;
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new FRMSCoreAuthorizationProvider()
                , new HR.HRAuthorizationProvider(new ApplicationAuthorizationProvider(_abpPermissionBaseAppService))
                )
