...
namespace ZCYX.FRMSCore.Application
{
    ...
    public static class WorkFlowExtensions
    {
        ...
        public static long? Tolog(this decimal? dec)
        {
            if (dec == null) return null;
        ...
        {
            return date == null ? DateTime.Now : date.Value;
        }
        ...
        {
            return str.IsNullOrEmpty() ? "" : str.Replace(oldString, newString, true, System.Globalization.CultureInfo.CurrentCulture);
        }
        /// <summary>
        /// 获取汉字拼音的第一个字母
        /// </summary>
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        public static string GetCnFirstChart(this string str) {
            var ret = "";
            foreach (var c in str) {
                ...
                if ((int)c <= 127) {
                    ...
                    String firstPinyin = pinyins[0].Substring(0, 1);
                    ret += firstPinyin;
                }
        ...
        public static string RemoveHTML(this string Htmlstring)
        {
            ...
            Htmlstring = System.Net.WebUtility.HtmlEncode(Htmlstring).Trim();
        ...
        {
            return str.IsNullOrEmpty() ? string.Empty : System.Net.WebUtility.UrlEncode(str.Replace("+", "%2B"));
        }
        /// <summary>
        /// URL解码
        /// </summary>
        ...
        {
            return str.IsNullOrEmpty() ? string.Empty : System.Net.WebUtility.UrlDecode(str);
        }
        ...
        ///// <param name="button"></param>
        ///// <param name="newText">点后的显示文本</param>
        //public static void ClickDisabled(this System.Web.UI.WebControls.LinkButton button, string newText = "")
        //{
        //    if (button == null) return;
        //    StringBuilder js = new StringBuilder();
        //    System.Web.UI.Page page = (System.Web.UI.Page)HttpContext.Current.Handler;
        ...
        //public static System.Web.Routing.RouteValueDictionary ToRouteValueDictionary(this string urlQuery)
        //{
