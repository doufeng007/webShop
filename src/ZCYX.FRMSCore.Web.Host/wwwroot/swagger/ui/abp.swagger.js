...
(function () {
    ...
    abp.swagger.openAuthDialog = function (loginCallback) {
       ...
       //createInput(modalUxContent, 'tenancyName', 'Tenancy Name (Leave empty for Host)');
        createInput(modalUxContent, 'userName', '用户名','admin');
        createInput(modalUxContent, 'password', '密码','qaz123456', 'password');
    ...
    function createInput(container, id, title,value, type) {
