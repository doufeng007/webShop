...
namespace Project
{
    [Table("OAContractCollectionFee")]
    public class OAContractCollectionFee : FullAuditedEntity<Guid>
    {
        #region 表字段
        ...
        /// 
        /// </summary>
        [DisplayName("CollectionFeeType")]
        public string CollectionFeeType { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [DisplayName("CollectionFeeTypeCode")]
