...
namespace Abp.Excel
{
    public class AbpExcelModule : AbpModule
    {
        public override void PreInitialize()
        {
            //各种配置
            //为应用添加语言
            Configuration.Localization.Languages.Add(new LanguageInfo("zh-CN", "Chinese", "demo-language-css", true));
...
注意：当给内嵌的XML文件起名字时，要加上语言后缀，但是不要使用“.”，比如“MySource.ch.xml”，而要使用短号“-”，比如“MySource-en.xml”。因为当寻找资源时，“.”会造成问题。
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AbpExcelModule).GetAssembly());
